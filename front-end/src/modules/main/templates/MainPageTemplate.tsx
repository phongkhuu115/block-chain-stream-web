        ...
        <ul className="flex-1 px-2 py-4 bg-gray-800">
          {
            ...
            data.map((item, index) => (
              <Link key={index} href="#" className="flex w-full items-center  text-gray-100 hover:bg-gray-700">
                <li className=" w-full">
...
const MainPageTemplate = () => {
  ...
  return (
    <main className='container flex flex-col min-h-screen pt-3 medium:!p-5 gap-2'>
      ...
      <section className='medium:flex medium:gap-2 w-full h-[50vh] medium:h-[70vh]' >
        ...
        <div className='medium:basis-[20%] h-full'>
