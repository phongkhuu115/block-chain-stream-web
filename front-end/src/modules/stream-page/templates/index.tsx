                ...
                <div className='mx-auto'>
                  <div className='card md:flex '>
                    <div className='flex center-item'>
                      <Avatar
                        className='object-cover rounded-full w-24 h-24 m-3'
                        src={
                          streamData.Owners.user_avatar
                            ? streamData.Owners.user_avatar
                            : 'https://tailwindflex.com/public/images/user.png'
                        }
                      ...
                      <div className='flex gap-4'>
                        <div>
                          ...
                          <h3 className='text-xl heading'>
                            @{streamData.Owners.username}
                          </h3>
                          <p className='mt-2 mb-3'>
                            {followersCount
                              ? abbreviateNumber(followersCount)
                              : 'I have no follower yet'}{' '}
                          </p>
                        </div>
                        <div className='flex center-item'>
